...
- Decide cookie basics now (dev vs prod toggles)

- Confirm client knows where the API lives (local + prod)

**Gate**

App boots locally with env-driven config (no hardcoded URLs)
